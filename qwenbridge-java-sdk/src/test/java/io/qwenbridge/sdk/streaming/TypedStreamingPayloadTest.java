...
class TypedStreamingPayloadTest {
    ...
    void shouldMapKnownStreamingPayloads() throws Exception {
        ...
        ConnectedStreamingPayload connected =
                (ConnectedStreamingPayload) events.get(0).payload();
        ...
        AITokenStreamingPayload token =
                (AITokenStreamingPayload) events.get(1).payload();
        ...
        AICompletedStreamingPayload completed =
                (AICompletedStreamingPayload) events.get(2).payload();
        ...
        AIFailedStreamingPayload failed =
                (AIFailedStreamingPayload) events.get(3).payload();
    ...
    void shouldKeepUnknownPayloadAsRawData() throws Exception {
        ...
        UnknownStreamingPayload unknown =
                (UnknownStreamingPayload) events.getFirst().payload();
    ...
    private HttpServer startSseServer(String body) throws IOException {
        ...
        httpServer.createContext("/api/v1/search/stream/req-typed", exchange -> {
