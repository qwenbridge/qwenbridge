...
class QwenBridgeClientTest {
  ...
  void shouldMapSuccessfulAnalyzeResponse() throws Exception {
    ...
    SearchAnalyzeResponse response =
        client().analyze(SearchAnalyzeRequest.withRequestId("req-123", "iphone"));
  ...
  void shouldMapApiErrorResponse() throws Exception {
    ...
    QwenBridgeApiException exception =
        assertThrows(
  ...
  void shouldMapSuccessfulAsyncAnalyzeResponse() throws Exception {
    ...
    SearchAnalyzeResponse response =
        client().analyzeAsync(SearchAnalyzeRequest.withRequestId("async-req-123", "laptop")).join();
  ...
  void shouldRetrySyncAnalyzeOnServiceUnavailableAndReturnSuccess() throws Exception {
    ...
    QwenBridgeClient retryingClient =
    ...
    SearchAnalyzeResponse response =
        retryingClient.analyze(SearchAnalyzeRequest.withRequestId("retry-req", "monitor"));
  ...
  void shouldRejectBlankQueryBeforeHttpCall() {
    IllegalArgumentException exception =
        assertThrows(IllegalArgumentException.class, () -> SearchAnalyzeRequest.of(" "));
  ...
  private HttpServer startServer(
      int status, String responseBody, AtomicReference<String> requestIdHeader) throws IOException {
    HttpServer httpServer = HttpServer.create(new InetSocketAddress(0), 0);
