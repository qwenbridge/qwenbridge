...
public record ThreatExplanation(
  ...
  public ThreatExplanation {
    ...
    matchedCorrelationRules =
        matchedCorrelationRules == null ? List.of() : List.copyOf(matchedCorrelationRules);
  }

  public static ThreatExplanation none() {
    return new ThreatExplanation(ThreatRiskLevel.NONE, ThreatDecision.ALLOW, List.of(), List.of());
  }
}
