...
public class GlobalExceptionHandler {
  ...
  ResponseEntity<ApiError> handleHttpMessageNotReadable(
    ...
    return buildError(
        HttpStatus.BAD_REQUEST, ErrorCode.BAD_REQUEST, "Malformed JSON request body", request);
  }
  ...
  ResponseEntity<ApiError> handleAIProvider(AIException exception, HttpServletRequest request) {
    return buildError(
  ...
  ResponseEntity<ApiError> handleSearchProvider(
      SearchProviderException exception, HttpServletRequest request) {
    return buildError(
        HttpStatus.BAD_GATEWAY,
