...
public class OperationsMetrics {
    ...
    public void recordAiProvider(String provider, String operation, String outcome, Duration duration) {
    ...
    public void sessionClosed(String reason) {
        ...
        Counter.builder(PREFIX + ".sse.sessions.closed").tag("reason", reason).register(registry).increment();
    }
