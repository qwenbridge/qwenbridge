...
public class OpenSearchClient {
    ...
    public OpenSearchClient(@Qualifier("openSearchWebClient") WebClient openSearchWebClient, OperationsMetrics metrics) {
    ...
    public Map<String, Object> search(String index, Map<String, Object> query) {
        ...
        try {
            Map<String, Object> response = openSearchWebClient
                    .post()
