...
public record SearchRequest(
    String query, Map<String, Object> constraints, Map<String, Object> options) {
  ...
  public static SearchRequest withOptions(String query, Map<String, Object> options) {
  ...
  private static SearchRequest withModeAndEmbedding(
      String query, String mode, List<Double> embedding) {
    return withOptions(
        query, Map.of(OPTION_SEARCH_MODE, mode, OPTION_EMBEDDING, List.copyOf(embedding)));
  }
}
