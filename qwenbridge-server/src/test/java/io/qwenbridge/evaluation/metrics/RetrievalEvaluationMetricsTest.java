...
class RetrievalEvaluationMetricsTest {
    ...
    private final EvaluationQuery query = new EvaluationQuery(
            "q1",
            "gaming mouse",
            List.of(
    ...
    void shouldCalculatePrecisionAtK() {
        double value = metrics.precisionAtK(
                query,
                List.of("doc-3", "doc-1", "doc-2"),
                3
        );
    ...
    void shouldCalculateRecallAtK() {
        double value = metrics.recallAtK(
                query,
                List.of("doc-3", "doc-1", "doc-2"),
                3
        );
    ...
    void shouldCalculateReciprocalRank() {
        double value = metrics.reciprocalRank(
                query,
                List.of("doc-3", "doc-3b", "doc-2")
        );
    ...
    void shouldCalculateNdcgAtK() {
        double value = metrics.ndcgAtK(
                query,
                List.of("doc-2", "doc-3", "doc-1"),
                3
        );
