...
class PipelineStreamingEventMapperTest {
  ...
  private final PipelineStreamingEventMapper mapper = new PipelineStreamingEventMapper();
  ...
  void shouldMapPipelineEventToPublicStreamingEnvelope() {
    ...
    SnapshotStreamingPayload payload = (SnapshotStreamingPayload) streaming.payload();
