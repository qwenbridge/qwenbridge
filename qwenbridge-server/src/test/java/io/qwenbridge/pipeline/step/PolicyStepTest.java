...
class PolicyStepTest {
  ...
  void shouldPassCleanRewrites() {
    ...
    context.store(
        RewriteResult.class, new RewriteResult(true, "mock", List.of("desk", "office desk")));
  ...
  void shouldBlockAdultContent() {
    ...
    context.store(RewriteResult.class, new RewriteResult(true, "mock", List.of("adult desk")));
