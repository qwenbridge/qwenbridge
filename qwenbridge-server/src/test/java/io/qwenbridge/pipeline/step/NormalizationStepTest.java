...
class NormalizationStepTest {
  ...
  void shouldNormalizeRequestQuery() {
    NormalizationStep step =
        new NormalizationStep(new DefaultInputNormalizer(List.of(new UrlDecodeNormalizer())));
  ...
  void shouldExposeNormalizedInputAsResultType() {
    NormalizationStep step = new NormalizationStep(new DefaultInputNormalizer(List.of()));
