...
class DefaultInputNormalizerTest {
  ...
  void shouldNormalizeInputThroughAllRules() {
    List<InputNormalizationRule> rules =
        List.of(
    ...
    NormalizedInput result =
        normalizer.normalize("  %253Cscript%253Ealert%25281%2529%253C%252Fscript%253E  ");

    assertThat(result.originalQuery())
        .isEqualTo("  %253Cscript%253Ealert%25281%2529%253C%252Fscript%253E  ");
